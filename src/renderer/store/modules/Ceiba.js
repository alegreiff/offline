const state = {
  personajes: [
    ...
    },
    {
        ...
        order: 8,
        nombre: 'Rani',
        describe: `Rani es una rana verde de ojos rojos que nació en el bosque húmedo tropical del Chocó y que ahora vive en la parte baja de la Ceiba, en una bromelia. No se sabe bien si es él/ella, tiene mezclada sus preferencias. Para él/ella todo es actuar, no concibe la vida sin este arte. Con un movimiento rápido de manos pasado por la cara, Rani transforma su rostro fácilmente.

        Es un actor/actriz natural que siempre está ensayando sus monólogos. El problema es que nadie sabe en qué momento está ensayando y todos se creen la historia detrás de cada diálogo a lo que Rani siempre responde: ¡Qué buena actuación!, ¿verdad? `,
        imagen: 'B12.jpg',
