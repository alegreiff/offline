const state = {
  videos: [
    ...
    { id: 282,
      autor: 'Ministerio de Cultura - ICBF - Centro Ático',
      coleccion: 'Fiesta de la lectura',
      titulo: 'Tiki, tiki, tai - Video',
      describe: 'El pueblo Rrom o gitano tiene sus propias canciones en su idioma. El video de esta canción cuenta la historia de una pequeña niña que quiere jugar con su mariposa; podrás escucharla en su lengua original y también en español. ¿Cuáles son las mariposas que más te gustan?',
      url: '282-tiki.mp4'
    },
    { id: 283,
      autor: 'Ministerio de Cultura - ICBF - Centro Ático',
      ...
      describe: 'Si tienes ganas de bailar este video es para ti. ¡Imagina una tortuguita a la que no le gusta hacer nada más que bailar! ¿Cuál es el ritmo que más te gusta bailar y cómo lo haces?',
    ...
    { id: 284,
      ...
      describe: 'La hora de dormir es muy importante, cierra tus ojos rápidamente o un lobito vendrá, ¡pero no te asustes, que solo te acompañará! ¿Qué te gusta que te canten cuando vas a dormirte?',
      url: '284-dormis.mp4'
    },
    { id: 285,
      autor: 'Ministerio de Cultura - ICBF - Centro Ático',
