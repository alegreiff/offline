const state = {
  videos: [
    ...
    { id: 113,
      ...
      autor: 'Ministerio de Cultura - Con mi cuento encanto - Edson Velandia',
      coleccion: 'Karaokes',
      ...
      autor: 'María del Sol Peralta / Cantaclaro',
      coleccion: 'Karaokes',
