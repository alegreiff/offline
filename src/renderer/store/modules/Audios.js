...
—Ent dah mosa me. `
    ...
    { id: 27,
      ...
      url: '27-sarlerrom.mp3',
      letra: `Sas but bors, but bors, ay yek rom trailas con peski famili.
Lesko gras sas de sa eslavo ay leske punge sasbut koble, ay kana e famili bariolas, le grastes kerelasde sa but sor ay nastilas te pirelas, gero grastogo.
Ay kako burdón kai sirdelas o grass daba nastilas, kai sas but shavoge, ay o gras nastilas te pirel, ay zhalas ay abelas o gero grass nastil sirdelas o burdon de sa paro.

Sar o drom sas grapensa, ay o grass, zhalas ay avelas, po bas chacho ay o estingo, ay miskilaspe sa perenas le bucha, le piria, le estachuria, ay gata le shavoge nonitoria denas pesko seró ande e phúu.
...
He try to swallow the bath tub
But he couldn’t get it down

Miss Lucy call the doctor
Miss Lucy call the nurse
Miss Lucy call the lady
With the alliguieta purs

Miss Lucy punch the doctor
Miss Lucy punch the nurse
Miss Lucy punch the lady
With the alliguieta purs
...
Oloco, amaca, eleke, oloco
Oloco, amaca, eleke, oloco
Oloco, amaca, ataca, eleke

Ataca, aloko, omoco, alaca
Eteke, amaca, eleke, omoco
A poco, a paca, eleke, omoco
A paca, ameke, ameke
...
Mayaya O`
    ...
    { id: 204,
      ...
      url: '204-browngirl.mp3',
      letra: `There's a brown girl in the ring,
Tralalalala
...
Then you skip across the ocean,
Tralalalalala
Skip across the ocean, tralalalala
She look like a sugar inna ploom

Then you show me your motion,
Tralalalala
Then you show me your motion,
Tralalalalala
...
Papa bring kiek
Fi the biebi aluon
Biebi iit all and no gi
Mama non
Mama get vex and cho'weh the baby
Pujum, pujum
...
Biebi iit all and no gi
Mama none
Mama get vex and cho'weh the biebi
Pujum, pujum
And cho'weh the biebi
Pujum, pujum
...
Then, Brother Nancy woke up Brother Tiger and said, —Look, here is the one who ate the butter! It’s melting out of you all over! Tiger was so fooled that he said, —Yes, you’re right; it had to be me. I ate the butter. `
    ...
    { id: 294,
      ...
      url: '294-buykumun.mp3',
      letra: `Juga migutana me’zanundi
Bay kumun mikeywin
...
ponerme a coser. `
    ...
    { id: 427,
      ...
      titulo: 'Marisol y tiburón - cuento',
      describe: 'Escucha la historia de tiburón y su amiga Marisol y disfruta de una bonita canción que te invita a cuidar todo lo que te rodea.',
      url: '427-marisol.mp3',
      letra: ``
    },
    { id: 428,
      autor: 'Ministerio de Cultura - Con mi cuento encanto',
      coleccion: 'Con mi cuento encanto',
      titulo: 'Tortuguita - cuento',
      describe: 'Una pequeña y traviesa tortuga se extravió y un niño la rescató. ¿Qué pasaría con ella y con sus angustiados padres? Escucha esta historia acompañada de música para bailar.',
      url: '428-tortuguita.mp3',
      letra: ``
    },
    { id: 431,
      autor: 'Ministerio de Cultura - Con mi cuento encanto',
      coleccion: 'Con mi cuento encanto',
      titulo: 'La araña - cuento',
      describe: 'La araña estaba cansada de subir y bajar todo el día. Descubre lo que hará para no estar aburrida. ¿Qué haces cuando estas aburrido?',
      url: '431-laarana.mp3',
      letra: ``
    },
    { id: 433,
      autor: 'Ministerio de Cultura - Con mi cuento encanto',
      coleccion: 'Con mi cuento encanto',
      titulo: 'La reina flor - cuento',
      describe: 'Esta es la historia de la reina de las flores y un pájaro travieso que se encuentra con ella. ¿Cómo imaginas que sea la reina flor?',
      url: '433-reinaflor.mp3',
      letra: ``
    },
    { id: 435,
    ...
    { id: 436,
      ...
      url: '436-mariamulatas.mp3',
      letra: ``
    },
    { id: 437,
      autor: 'Ministerio de Cultura - Con mi cuento encanto',
      coleccion: 'Con mi cuento encanto',
      titulo: 'La cucarachita Martínez - cuento',
      describe: 'Cucarachita se ha puesto muy bonita para conseguir un novio, pero las cosas no le salen como ella espera. Escucha cómo le cantan a la cucarachita para enamorarla.',
      url: '437-cucarachita.mp3',
      letra: ``
    },
    { id: 445,
      autor: 'Ministerio de Cultura - Con mi cuento encanto',
      coleccion: 'Con mi cuento encanto',
      titulo: 'Los ratones - cuento',
      describe: 'Unos pequeños ratones hambrientos han salido al bosque en busca de un poco de alimento, pero ¡un gato los ha encontrado! ¿Qué les pasará a los ratoncitos?',
      url: '445-losratones.mp3',
      letra: ``
    },
    { id: 474,
      autor: 'Rafael Pombo',
      ...
      url: '474-juanmatachin.mp3',
      letra: `¡Mírenle la estampa!
Parece un ratón
...
a Juan Matachín!”. `
    ...
    { id: 475,
      ...
      url: '475-mirronga.mp3',
      letra: `Mirringa Mirronga, la gata candonga,
...
para que hagan cenas con tortas ajenas.`
    ...
    { id: 476,
      ...
      url: '476-ballenero.mp3',
      letra: `Yo soy Juaco el ballenero
...
- “¡Ah!” dijo el zorro: “siempre eres fea;
 pero adornada: ¡mil veces más!”`
    ...
    { id: 478,
      ...
      url: '478-sietevidasgato.mp3',
      letra: `Preguntó al gato Mambrú
...
expiró la mariposa.`
    ...
    { id: 485,
      ...
      url: '485-renacuajo.mp3',
      letra: `El hijo de Rana, Rinrín Renacuajo,
...
¡y mamá Ranita solita quedó!`
    ...
    { id: 488,
      ...
      url: '488-elgatobandido.mp3',
      letra: ` Michín dijo a su mamá:
...
Viene del llano,
Un armadillo dj que desde temprano
Pone su música para que sus hermanos
Puedan bailar, puedan cantar
Para que todos se pongan a zapatear

A Arma – DJ  le gusta que bailen con él,
...
Arma - DJ
El armadillo dj que siempre deslumbra
Porque si viene seguro es buena la rumba
Pueden bailar, pueden cantar
Para que todos se pongan a zapatear

A Arma - DJ le gusta que bailen con él,
Y cuando la fiesta empieza
Todos mueven su cabeza
...
Arma – DJ
El armadillo dj que tiene testigos
Que pone música para que sus amigos
Puedan bailar, puedan cantar
Para que todos se pongan a zapatear

A Arma – DJ  le gusta que bailen con él,
Y cuando se pone coqueto
Se mueve tu esqueleto
...
Que Arma – DJ  solo vino para alegrar
Pero ya todos, están cansados
Y ya se quieren sentar en cualquier lugar
A  descansar`
    },
    { id: 625,
      autor: 'Ricardo Prado',
...
Le pusieron pollo y una costilla
Papas bien peladas y en rodajas otras más
Un huevito duro y el arroz cocido
Y en hoja de plátano enrollaron el manjar
...
Le pusieron fríjol, plátano maduro
Arepita paisa, carne en polvo y chicharrón
La morcilla, el arroz
...
¿Y de postre?`
    ...
    { id: 626,
      ...
      url: '626-losmenjurjes.mp3',
      letra: `Gildardo tiene un montón de menjurjes
Que mejoran hasta el mal de sirirí
Gildardo tiene un montón de hierbas
Para el cólico y jarabes pa’ la tos
Pero nadie puede repetir las retahílas que se inventa
Cuando prende su altavoz

Vendo, vendo
Vendo chipi chipi, paco paco
Zarigüeya y chicharrón
Vendo bebedizo de quicuyo, tomillo, albahaca y menta
Que le quita el comezón

Aguacateca para la pecueca
Tela de araña para las lagañas
Canutillo pa’ que haga pipí
Y caimito pa’ calmar el popó, po, po, po (etc)

Gildardo tiene un montón de baratijas
Que le sirven pa’ arreglar hasta un balín
Gildardo puede arreglar inclusive
...
Los cojo todos, todos, los mojo con bombón
...
12 niños se quedan en casa con papá
27 niños en la mesa
27 desayunos para preparar
Linio y Tulita no se cansan de cuidar

¡Mamá, me falta un zapato!
¿Quién ha visto mis crayolas de pintar?
¡Yo no tengo ganas de desayunar!
¡Faltan 5 cuyecitos por bañar!

27 platos y pocillos
27 camas por organizar
27 sábanas y fundas
27 medias y calzones por lavar
15 a la escuela y otros 12 con papá

Tres guagüitas se escaparon
Se fueron a la piscina a nadar
Otros 4 querían irse pal’ volcán
Y los otros 5 se pusieron a gritar

Linio cuida a los guaguas en casa
Y Tulita en la escuela les enseña a sembrar
Linio lava, juega y cocina
Y Tulita en la escuela no se aburre de jugar
Linio y Tulita están felices de criar
...
SAIMIRI:  Ya llegaron Linio y Tulita, los cuyes
LINIO:  Si el abuelo llama hay que ir
TULITA: De la madriguera hay que salir
L Y T:  Y aunque queremos saber qué pasa
		los niños quedaron solos en casa
SAIMIRI:  ¿Cuántos niños tienen?
L Y T:  Eh, 27
TODOS:  Uuyyyyy

SAIMIRI:  Llegó Rani, la actriz
RANI: Me encontraba en un ensayo
		Cuando oí el maguaré
		Y si pasa algo en la Ceiba
		aquí yo me enteraré.
SAIMIRI:  ¿Y qué estabas ensayando?
RANI: Una escena de llorar ( llora )

SAIMIRI:  Bertilda y Edilberto, mis tíos cocineros
EDILBERTO:  Piqué perejil, cebolla y tomate
		Aceite de olivas y un poco de sal
...
ARMA DJ:  Toda la música puede sonar, joropos, bambucos, andinas y rap
		Soy un DJ, le pongo play
		Y ahí mismo la gente se pone muy bien.
		Si quieren los pongo un rato a bailar
		Con merengue, con salsa, bachatas o rock
...
CHIP: Vengan, vamos todos.

SAIMIRI:  También llegaron la tortuga Gigi y Maya la Guacamaya
GIGI: Disculpen que me hubiera demorado
		Pero es que sin mis libros
		No me gusta salir
MAYA: En cambio a mi si me gusta volar
		Mirando noticias de aquí y de allá
		Y quiero decirte mi amiga Gigi
		Que todos tus libros me encantan a mí

SAIMIRI:  Gildardo, el vendedor
GILDARDO: Yo me vine con la carreta por si alguien quiere comprar paletas
		Les traigo dulces de asaí, con chirimoyas de Necoclí
		Le tengo la gafa, manillas de plata, cocadas y obleas de leche cortada
		Les traigo limones, naranjas, anones, les traigo las frutas
		De muchos sabores
...
Todos querían saber qué pasó pero al abuelo se le olvidó`
    ...
    { id: 629,
      ...
      url: '629pitequerepite.mp3',
      letra: `¿Quién contará que Rani está
Lista para hacer su show?
Maya, Maya, Guacamaya

¿Y quién dirá que en la biblioteca
Gigi puso una ludoteca?
Maya, Maya, Guacamaya

¿Y quién dirá que a Saimiri le pasó
Que de una liana resbaló
Y “toditico” se embarró?

Maya, Maya, Guacamaya
Todo lo que pasa siempre lo quiere contar
Maya, Maya, Guacamaya
Todas sus noticias son historias de verdad

Transmitiendo desde la Ceiba su periodista Maya los saluda
Hoy estamos buscando niños que acepten el reto de repetir la siguiente noticia:

Desde el Amazonas
Desde el Amazonas llegó Saimiri
Desde el Amazonas llegó Saimiri con su tío y su tía
Desde el Amazonas llegó Saimiri con su tío, su tía y las tres terrillizas

Y ahora tiene
Y ahora tiene un montón de amiguitos
Y ahora tiene un montón de amiguitos: Cuyes, tortuga y Arma DJ.
Y ahora tiene un montón de amiguitos: Cuyes, tortuga y Arma DJ,
Camaleóna, olinguito y la rana también
Y ahora tiene un montón de amiguitos: Cuyes, tortuga y Arma DJ,
Camaleóna, olinguito y la rana también y su abuelo que sabe tocar maguaré.
...
Muevo los hombros, sacudo la cola
Me cojo la cabeza y me río así
...
Me siento en el piso, cruzo los brazos
Tomo mucho aire y grito así
...
¡No quiero tomar sopa!`
    ...
    { id: 631,
      ...
      url: '631-lacancionsincancion.mp3',
      letra: `Eliana, Adriana y Juliana nacieron una mañana
Al mismo tiempo las tres
Y ahí mismo las juguetonas, a la mama y a la nana
Las pusieron a correr

Adriana, la que no podía ver, se iba a subir a un árbol
Y Eliana la que no podía oír también se iba a escalar

Y Juliana sin su diente se animaba de repente

Eliana, Adriana y Juliana se divertían pintando
Y en esas se la pasaban
Y si alguien se molestaba, cambiaban de opinión
Con tanta imaginación

Eliana, Adriana y Juliana son artistas muy famosas
Y cuando trabajan juntas, las tres son más poderosas

Una tarde se inventaron una canción sin canción...

Vamos a cantar con las terrillizas una canción sin canción
Decimos una frase y vamos quitando palabra por palabra
¡Hay que aprender el gesto!

Vamos - a jugar - a hacer - un tren
...- a jugar- a hacer- un tren
...- ...- a hacer- un tren
...- ...- ...- Un tren
...- ...- ...- ...

Eso ¿Ya aprendimos todos? ¡Cantemos otra canción sin canción!

Las tres - en equipo - somos - invencibles
...
const getters = {
    audiosCeiba: state => {
      return state.canciones.filter(cancion => cancion.coleccion == 'Maguaré en La Ceiba')
    },
    audiosCuentosaloido: state => {
      return state.canciones.filter(cancion => cancion.coleccion == 'Cuentos al oído')
    },
